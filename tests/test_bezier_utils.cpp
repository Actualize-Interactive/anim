...
TEST_CASE("Bezier curve evaluation", "[bezier_utils]") {
    SECTION("Evaluate cubic Bézier at t=0") {
        ...
        Point2D result = bezier_utils::evaluate_cubic_bezier(p0, p1, p2, p3, 0.0);
    ...
    SECTION("Evaluate cubic Bézier at t=1") {
        ...
        Point2D result = bezier_utils::evaluate_cubic_bezier(p0, p1, p2, p3, 1.0);
    ...
    SECTION("Evaluate cubic Bézier at t=0.5") {
        ...
        Point2D result = bezier_utils::evaluate_cubic_bezier(p0, p1, p2, p3, 0.5);
...
TEST_CASE("Finding parameter for time", "[bezier_utils]") {
    ...
    SECTION("Parameter for linear segment") {
        ...
        Point2D result = bezier_utils::evaluate_cubic_bezier(p0, p1, p2, p3, t_mid);
    ...
    SECTION("Parameter for curved segment") {
        ...
        Point2D p0(0.0, 0.0);
        Point2D p1(0.0, 1.0);  // Vertical handle
        Point2D p2(3.0, 2.0);  // Handle closer to p3
        Point2D p3(3.0, 3.0);
        ...
        // Evaluate to verify
        Point2D result = bezier_utils::evaluate_cubic_bezier(p0, p1, p2, p3, t);
        REQUIRE(result.time == Catch::Approx(1.5).margin(0.01));
    }
